...
test('create question with proper parameters', async () => {
  const res = await createMcqQuestionCore(
    hostPlayerId,
    roomId,
    'foo question',
    ['a', 'b', 'c', 'd'],
...
test('create question with empty question title and options', async () => {
  await expect(
    createMcqQuestionCore(
      hostPlayerId,
      roomId,
...
test('create question with empty question room,title, and options', async () => {
  await expect(
    createMcqQuestionCore(
      hostPlayerId,
      undefined,
...
test('create question with empty host,question room,title, and options', async () => {
  await expect(
    createMcqQuestionCore(
      undefined,
      undefined,
